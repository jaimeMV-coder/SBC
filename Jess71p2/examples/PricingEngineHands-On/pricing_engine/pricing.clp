...
;;Nuevas reglas
(defrule 24-months-interest
    "In the purchase of an /iPhone 11 Pro/, with Banamex cards, offer 24 months without interest."
    ...
    =>
    (add (new Offer "iPhone 24-monthly payment"   (/ ?price 24))))

(defrule 12-months-interest
    "In the purchase of an /Samsung Note 11/, with Liverpool VISA cards, offer 12 months without interest."
    (CatalogItem (partNumber ?partNumber) (description /Samsung Note 11/) (price ?price))
    (CreditCard (name /Liverpool VISA/)(type /Bank issues/))
    (OrderItem (partNumber ?partNumber))
    =>
    (add (new Offer "Samsung Note 11 12-monthly payment"   (/ ?price 12))))

(defrule 100pesosCupon
    "When buying a /MacBook Air/, offer 100 pesos in vouchers for every 1000 pesos in the purchase."
    (CatalogItem (partNumber ?partNumber) (description /MacBook Air/) (price ?price))
    (OrderItem (partNumber ?partNumber))
    =>
    (add (new Offer "Coupons"   (/ ?price 1000))))
